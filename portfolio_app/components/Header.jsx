...
function Header() {
  ...
  return (
    <div
      className={`transition-all duration-500 ${theme} sticky   top-0 z-50  ${
        scrolled ? `border-b shadow-lg py-4 ${theme}` : "py-6"
      } `}
    >
      ...
      <div className="container mx-auto  ">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-x-8">
            ...
            <nav className="hidden md:flex gap-x-10 items-center justify-center">
              <Link
